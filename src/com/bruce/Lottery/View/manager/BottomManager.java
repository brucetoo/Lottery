...
public class BottomManager implements Observer{
	...
	public void init(Activity activity) {
		bottomMenuContainer = (RelativeLayout) activity.findViewById(R.id.br_bottom);
		commonBottom = (LinearLayout) activity.findViewById(R.id.br_bottom_common);
		playBottom = (LinearLayout) activity.findViewById(R.id.br_bottom_game);

		playBottomNotice = (TextView) activity.findViewById(R.id.br_bottom_game_choose_notice);
		cleanButton = (ImageButton) activity.findViewById(R.id.br_bottom_game_choose_clean);
		addButton = (ImageButton) activity.findViewById(R.id.br_bottom_game_choose_ok);
