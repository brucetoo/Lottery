...
//	actvalue int * 用户账户余额
    ...
    public void serializeElement(XmlSerializer serializer) {
        try {
            ...
            issue.serializeLeaf(serializer);
            lotteryvalue.serializeLeaf(serializer);
            lotterynumber.serializeLeaf(serializer);
            appnumbers.serializeLeaf(serializer);
            issuesnumbers.serializeLeaf(serializer);
            lotterycode.serializeLeaf(serializer);
            issueflag.serializeLeaf(serializer);
            bonusstop.serializeLeaf(serializer);
